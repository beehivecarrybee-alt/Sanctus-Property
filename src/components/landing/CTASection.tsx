export function CTASection() {
  return (
    <section id="contact" className="relative py-32 md:py-40 bg-ink text-background overflow-hidden" style={{ backgroundColor: "oklch(0.16 0.008 80)", color: "oklch(0.985 0.008 85)" }}>
