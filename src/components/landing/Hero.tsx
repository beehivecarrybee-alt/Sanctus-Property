...
export function Hero({ images }: Props) {
  ...
  return (
    <section ref={sectionRef} id="home" className="relative h-[250vh] md:h-[350vh]">
      <div className="sticky top-0 h-dvh md:h-screen w-full overflow-hidden">
        <div className="mx-auto max-w-7xl h-full px-6 lg:px-10 grid md:grid-cols-12 gap-8 content-center items-start md:items-center pt-20 md:pt-24 pb-8">
