...
import ecLogo from "../assets/logofor E and C_.jpg?url";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Sanctus Property 2026" },
      { property: "og:title", content: "Sanctus Property — Real Estate & Property Studio" },
      { property: "og:description", content: "Sanctus Property designs, develops and delivers residential and commercial landmarks." },
